...
//Создаем 9 менеджеров 1 ранга. Пользуюсь циклом только потому что мне лень делать это вручную. Хоть так и не должно быть на самом деле, но тем не менее логику добовления сотрудников это не нарушает.
for ($i = 0; $i < 9; $i++) {
